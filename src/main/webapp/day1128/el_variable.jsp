      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               pageContext.setAttribute("today", day);
               %>
               ...
               <div>
               <!-- 3. EL에서는 scope 객체명으로 변수를 사용. -->
               메시지 : ${ pageScope.todayMsg }<br>
               ${ pageScope.today }일<br>
               </div>
               <div>
               <%
               // scope객체에 값 할당
               ...
               applicaionScope : ${ applicationScope.appName } (${ appName })<br>
               <hr>
               <!--  scope 객체가 이름이 같다면 page > request > session > application
               순서로 접근하여 사용한다. -->
               ${ sName }
               </div>
            </div>
