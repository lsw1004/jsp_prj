		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					%>
					입력하신 ${param.id }는 이미 사용중입니다.<br> 다른 아이디를 입력해보세요.<a
						href="javascript:history.back()" class="btn btn-success">뒤로</a>
					<%
					} else {
               ...
               코드 : ${param.code }<br>
							...
							<div>
								...
								if (lang != null) {// NullPointerExcetion 발생을 막기 위해서
						...
						<c:otherwise>
							<img alt="" src="../common/images/fail.png">
							<br>
