...
$(function(){
   $("#btnFile").click(function() {
	...
	$("#upfile").change(function(evt) {
		...
		/* 
		// 업로드 가능 확장자는 gif, jpg, png, bmp만 가능 체크코드 작성
		...
		if(!flag){
			alert("업로드 가능한 파일은 gif, jpg, png, bmp 만 가능합니다.");
			return;
		}// end if
		 */
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               enctype="multipart/form-data" : binary 전송방식
                -->
               <form action="uploadFrmProcess.jsp" method="post" enctype="multipart/form-data" id="frm" name="frm">
               <label>업로더</label>
               ...
               업로드는 이미지(gif, jpg, png, bmp)만 가능합니다.
