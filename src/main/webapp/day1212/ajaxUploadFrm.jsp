...
$(function(){
   $("#btnFile").click(function() {
	...
	$("#btnFileUpload").click(function() {
		...
		var formData = new FormData(form);// 파라메터 전송 방식 -> 파일 전송 방식
		
		$.ajax({
			url:"ajaxFileProcess.jsp",
			contentType:false,// ajax의 요청 방식을 binary 전송 방식으로 변경
			processData:false,// ajax 요청에 query string 붙지 않게 막기
			type:"post",
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               enctype="multipart/form-data" : binary 전송방식
                -->
               <form action="ajaxUploadFrmProcess.jsp" method="post" id="frm" name="frm">
               <label>업로더</label>
               ...
               <br>
               <label>파일</label><br>
               <img src="../upload/default_img.png" id="preview" style="width: 100px; height: 100px; border-radius: 50px"/>
