...
<link rel="shortcut icon"
	href="http://192.168.10.96/jsp_prj/common/images/favicon.ico">
...
<link href="http://192.168.10.96/jsp_prj/common/css/carousel.css"
	rel="stylesheet">
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div>
					...
					// rDTO는 시작 번호와 끝 번호를 web parameter로 받지 않는다.
					// 연산된 값(1항~5항)으로 설정한다.
					rDTO.setStartNum(startNum);
					rDTO.setEndNum(endNum);

					// 6.시작번호와 끝번호 사이에 해당하는 모든 게시글을 조회
					List<BoardDTO> boardList = bs.searchBoardList(rDTO);

					// 글제목이 20글자를 초과하면 19자까지만 보여주고 나머지는 ...으로 처리.
               ...
               끝번호 : ${ endNum }<br>
                --%>
					...
					<div id="boardList" style="min-height: 500px;">
						...
						<input type="button" value="글쓰기" class="btn btn-success btn-sm"
							id="btnWrite">

						<table class="table table-hover">
							<thead>
								<tr>
									<th style="widows: 80px;">번호</th>
									<th style="widows: 450px;">제목</th>
									<th style="widows: 150px;">작성자id</th>
									<th style="widows: 150px;">ip</th>
									<th style="widows: 80px;">조회수</th>
									<th style="widows: 200px;">작성일</th>
								</tr>
							</thead>
							<tbody>
								<c:if test="${empty boardList }">
									<tr>
										<td colspan="6" style="text-align: center;">작성된 게시글이
											없습니다.</td>
									</tr>
								</c:if>
								...
								<c:forEach var="bDTO" items="${boardList}" varStatus="i">
									<tr>
										...
										<td><a href="boardDetailFrm.jsp?num=${bDTO.num}">${bDTO.title}</a>
										</td>
               ...
               [<a class="a"
								href="boardList.jsp?currentPage=${tPage}&field=${param.field}&keyword=${param.keyword}">${tPage}</a>]
