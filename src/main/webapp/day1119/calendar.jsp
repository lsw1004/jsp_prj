...
.blackTd{background-color: background;}

.sunText{color: #da3f35;}
.weekText{color: inherit;}
  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="calWrap">
            <!-- parameter 값 처리 -->
            <jsp:useBean id="cDTO" class="day1128.CalendarDTO"/>
            ...
            // 입력된 년 받기 : parameter가 존재하지 않으면 null 발생
            //String paramYear = request.getParameter("paramYear");
            String paramYear = cDTO.getParamYear();
            //log("========>paramYear : " + paramYear);
            if(paramYear != null){
            ...
            if(paramMonth != null){
	            ...
	            // Calendar 객체의 월은 0월 ~ 11월 12달을 사용. (사람의 월보다 1 적다.)
            }// end if
			...
			for(int tempDay=1;;tempDay++){// 마지막 날을 모름
				...
				// ( 현재월에 없는 날짜가 입력되면 자동으로 다음달 1일이 된다.)
