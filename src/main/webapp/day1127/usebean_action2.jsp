      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               session : 	접속자마다 (웹 브라우저마다) 하나의 객체가 생성된고,
               				생성된 객체는 모든 JSP페이지에서 사용될 수 있다.
               application : 	최초 접속자에의해 하나의 객체가 생성되고,
               ...
               당신은 이 페이지에 <strong><jsp:getProperty property="cnt" name="counter"/></strong>번째 방문자입니다.
               당신은 이 페이지에 
            	   <%
            	   String temp = String.valueOf(counter.getCnt());
            	   for(int i = 0; i < temp.length(); i++){
            		   %> 
            		   <img src="images/num_<%=temp.charAt(i)%>.png"> 
            		   <%
            	   }
            	   %>번째 방문자 입니다.
            </div>
