  ...
  ================================================== -->
      ...
      <div class="container marketing">
         ...
         <div class="row featurette">
            <div class="col-md-7">
               <%-- forward로 이동한 페이지 : <%= ((Counter)request.getAttribute("counter")).getCnt() %> --%>
               <% 
               Object obj = session.getAttribute("counter"); 
               if(obj != null){
            	   Counter cnt = (Counter)obj;
            	   %>
            	   session : 당신은 이 페이지에 <%=cnt.getCnt() %>번째 방문자 입니다.
            	   <%
               }// end if
               %>
               <br>=========================================<br>
               ...
               if(obj2 != null){
            	   ...
            	   session : 당신은 이 페이지에 
            	   <%
            	   String temp = String.valueOf(cnt.getCnt());
            	   char temp2 = 0;
            	   for(int i = 0; i < temp.length(); i++){
            		   temp2 = temp.charAt(i);
            		   %> 
            		   <img src="images/num_<%=temp2%>.png"> 
            		   <%
            	   }
            	   %>번째 방문자 입니다.
            	   <%
